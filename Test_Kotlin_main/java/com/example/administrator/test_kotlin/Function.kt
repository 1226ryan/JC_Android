...
fun onlyReadMethod() {
    ...
    val map = mapOf("a" to 1, "b" to 2, "c" to 3)   // 읽기 전용 맵
}

fun sum(a: Int, b: Int) = a + b

fun comparison(a: Int, b: Int) = if (a > b) a else b
/* fun comparison(a:Int, b:Int): Int { return if(a>b) a else b } */
...
fun getRanges() {
    ...
    println("list.indices : ${list.indices}")       // 범위를 나타내는 것 "0..list.lastIndex" 와 같은 결과를 나타냄
