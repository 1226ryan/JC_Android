...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recycler_view, parent, false);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.mImage.setImageResource(items.get(position).getImageResouce());
    }
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            ...
            mImage = (ImageView) itemView.findViewById(R.id.itemImageView);
        }
    }
}
