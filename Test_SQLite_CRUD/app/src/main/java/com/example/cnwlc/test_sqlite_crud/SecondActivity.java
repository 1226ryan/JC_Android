...
public class SecondActivity extends AppCompatActivity {
    ...
    String tag = "SQLiteSecondActivity"; // Log의 tag 로 사용
    String tableNameTeacher = "teacher"; // DB의 table 명
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etContent = (EditText) findViewById(R.id.editText4);
    ...
    private void onClickEvent() {
        bInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(name) || "".equals(age) || "".equals(address) || "".equals(content)) {
    ...
    private void delete(String name) {
        int result = sqLiteDatabase.delete(tableNameTeacher, "name=?", new String[]{name});
        Log.d(tag, result + "개 row delete 성공");
        tv.setText(result + "개 row delete 성공");
        select(); // delete 후에 select 하도록
    }

    private void update(String name, int age, String address, String content) {
        ContentValues values = new ContentValues();
        values.put("age", age);         // 바꿀값
        values.put("address", address); // 바꿀값
        values.put("content", content); // 바꿀값

        int result = sqLiteDatabase.update(tableNameTeacher,
    ...
    private void select() {
        Cursor c = sqLiteDatabase.query(tableNameTeacher, null, null, null, null, null, null);
        while (c.moveToNext()) {
            int _id = c.getInt(0);
            ...
            Log.d(tag, "_id:" + _id + ",name:" + name
                    + ",age:" + age + ",address:" + address + ",content:" + content);
            tv.append("\n" + "_id:" + _id + ",name:" + name
                    + ",age:" + age + ",address:" + address + ",content:" + content);
    ...
    private void insert(String name, int age, String address, String content) {
        ContentValues values = new ContentValues();
        // 키,값의 쌍으로 데이터 입력
        ...
        long result = sqLiteDatabase.insert(tableNameTeacher, null, values);
