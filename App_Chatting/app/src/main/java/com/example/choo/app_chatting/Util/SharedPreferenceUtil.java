...
import com.example.choo.app_chatting.Common.ChattingApplication;
import com.example.choo.app_chatting.Common.Defines;
...
//        preferences = PreferenceManager.getDefaultSharedPreferences(ChattingApplication.getInstance());
        preferences = context.getSharedPreferences(ChattingApplication.userId, Context.MODE_PRIVATE);
